...
export const Union = () => {
  return (
    <div className='col-12 bg-color'>
        <div className='d-flex justify-content-evenly align-items-center flex-column-reverse flex-column flex-sm-row'>
            <div className='union-content col-lg-6 col-sm-12 col-md-8 p-3'>
