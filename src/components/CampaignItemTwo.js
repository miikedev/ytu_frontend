...
export const CampaignItemTwo = (props) => {
  ...
  return (
    <div className='d-flex justify-content-between align-items-center flex-column flex-column-reverse flex-lg-row mt-5 flex-md-row gap-1'>
        <div className='col-lg-5 col-md-6 col-11 d-flex flex-wrap align-items-center'>
            {
